import { Activity, BookOpen, Crown, TrendingUp, PlusCircle } from 'lucide-react';
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Card className="border-none shadow-sm bg-white dark:bg-zinc-900 overflow-hidden relative group">
            ...
            {/* Quick Access Area / Activity Feed */}
                            ...
                            {stats.recentActivities.length > 0 ? (
                                stats.recentActivities.map((activity, idx) => (
                                    <div key={idx} className="flex items-center gap-4">
                                        <span className={`w-2 h-2 rounded-full ${activity.is_paid ? 'bg-amber-500' : 'bg-blue-500'}`} />
